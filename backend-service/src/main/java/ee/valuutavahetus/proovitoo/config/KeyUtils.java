...
public class KeyUtils {
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        //V6tmete tegemine kui neid ei eksisteeri, productionis seda ei teha
    ...
    public RSAPublicKey getAcccessTokenPublicKey(){
        return (RSAPublicKey) getAccessTokenKeyPair().getPublic();
    };
    public RSAPrivateKey getAcccessTokenPrivateKey(){
